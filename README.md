...
* http://www.ethereum-alarm-clock.com/source/v0.7.0/
...
* [Day Limit](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/DayLimit.sol)

#### Ownership
* [Heritable](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/ownership/Heritable.sol)
* [Dead mans switch](https://github.com/skmgoldin/dead-mans-switch/blob/master/contracts/Dead.sol)
* [Role-Based Access Control](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/ownership/rbac/RBAC.sol)
...
* [Burnable Token](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/token/ERC20/BurnableToken.sol)
* [Token Timelock](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/token/ERC20/TokenTimelock.sol)
* [Token Vesting](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/token/ERC20/TokenVesting.sol)

#### Crowdsale
* [OpenZeppelin Crowdsale starter](https://github.com/OpenZeppelin/sample-crowdsale-starter)
* [Whitelist](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/ownership/Whitelist.sol)
...
## Libraries
* [StringUtils - Arachnid](https://github.com/Arachnid/solidity-stringutils)
* [StringUtils - Piper Merriam](https://github.com/pipermerriam/ethereum-string-utils/)
* [SafeMath](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/math/SafeMath.sol)
* [AddressUtils](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/AddressUtils.sol)
* [MerkleProof](https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/contracts/MerkleProof.sol)
* [Attribute Store](https://github.com/skmgoldin/sol-attrstore/blob/master/contracts/AttributeStore.sol)
